...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        @elseif(Auth::user()->role == "Sekretaris Program Studi")
            @include('template.sidebar.sekprodi')
        @elseif(Auth::user()->role == "Tim Akreditasi Program Studi")
            @include('template.sidebar.tim_akreditasi')
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @if(Auth::user()->foto)
                                    <img class="img-profile rounded-circle" src="{{ Auth::user()->foto }}" style="object-fit: cover;">
                                @else
