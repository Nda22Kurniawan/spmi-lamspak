...
<div class="container-fluid">
        ...
        <div class="card-body py-2">
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text bg-white text-primary border-right-0"><i class="fas fa-search"></i></span>
                </div>
                <input type="text" id="searchInput" class="form-control border-left-0 pl-0" placeholder="Cari Kode atau Nama Indikator di sini...">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            {{-- Tambahkan class 'cluster-card' untuk target filtering --}}
            <div class="card shadow mb-4 cluster-card">
                ...
                <div class="collapse show" id="collapseCluster{{ $cluster->id }}">
                    <div class="card-body p-2">
                        ...
                        {{-- Tambahkan class 'indicator-item' untuk target pencarian text --}}
                        <div class="card mb-3 {{ $bgCard }} shadow-sm py-2 indicator-item">
                            <div class="card-body">
